...
public class Notification extends BroadcastReceiver{
	...
	public void sendNotification(Context c, Intent i){
		...
		Intent shareIntent=ShareUtility.getShareIntent(c, d.getShareText(), d.getDescrizione());
		PendingIntent sharePendIntent=PendingIntent.getActivity(c, 0, shareIntent, 0);
	...
	public static void scheduleNotificationById(Context c, Data d) {
				...
				PendingIntent pi=PendingIntent.getBroadcast(c, 0, inte, PendingIntent.FLAG_UPDATE_CURRENT);

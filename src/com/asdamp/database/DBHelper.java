...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table date (posizione integer default 0,anno integer not null, mese integer not null, giorno integer not null, ora integer not null, minuto integer not null, millisecondiIniziali integer not null primary key, anni integer not null, mesi integer not null, settimane integer not null default 0, giorni integer not null, ore integer not null, minuti integer not null, descrizione text, colore text default '#0077A2');";
	public static final String DATABASE_NAME = "date.db";
	private static final String DATABASE_TEMP = "create table temp (posizione integer default 0,anno integer not null, mese integer not null, giorno integer not null, ora integer not null, minuto integer not null, millisecondiIniziali integer not null primary key, anni integer not null, mesi integer not null,settimane integer not null default 0, giorni integer not null, ore integer not null, minuti integer not null, descrizione text, colore text default '#0077A2');";

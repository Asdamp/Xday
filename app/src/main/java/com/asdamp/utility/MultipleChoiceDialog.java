...
public class MultipleChoiceDialog extends DialogFragment{
	...
	public static final String ERR_MIN_DATE="mdate";
	...
	public Dialog onCreateDialog(Bundle a) {
		...
		errMinDate=s.getString(ERR_MIN_DATE);
		...
		.setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener(){
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				else Toast.makeText((Context) chiamante, errMinDate, Toast.LENGTH_LONG).show();
